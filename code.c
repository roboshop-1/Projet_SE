...
//----- fonction remplacer une chaine par une autre chaine 
...
void traitement_ligne(char **argv)
{
	...
	{		
		...
		// else na5dho pwd legdim z nzidoloo esm dossier
		else
		{
...
//---- lecture derniere commande mel history kif na3mlo touche haute  sinon nulle
...
// affichage de promt --> nom directory + %
char *lecture()
{
char *tmp=NULL;
char *lu=NULL;
